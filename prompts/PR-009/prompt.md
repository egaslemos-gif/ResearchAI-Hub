...
A revisão deverá ter a seguinte estrutura:

## 1. Introdução (200-400 palavras)
- Contextualização do tema e da sua importância
- Apresentação da pergunta de investigação
- Objectivo da revisão
- Breve descrição da estrutura do texto
...
## 3. Lacunas e Limitações (200-400 palavras)
- Lacunas identificadas na literatura
- Limitações dos estudos analisados
- Oportunidades para investigação futura

## 4. Considerações Finais (200-400 palavras)
...
- Entre 1500 e 3000 palavras no total
